...
#include "../platforms/syberos/syberh-plugins/clipboard/clipboard.h"
...
void Clipboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::CreateInstance) {
        switch (_id) {
        case 0: { Clipboard *_r = new Clipboard();
...
QT_MOC_EXPORT_PLUGIN(Clipboard, Clipboard)
