...
#include "../platforms/syberos/syberh-plugins/packages/packages.h"
...
struct qt_meta_stringdata_Packages_t {
    QByteArrayData data[1];
    char stringdata0[9];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Packages_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Packages_t qt_meta_stringdata_Packages = {
    {
QT_MOC_LITERAL(0, 0, 8) // "Packages"
...
static const uint qt_meta_data_Packages[] = {
...
QT_INIT_METAOBJECT const QMetaObject Packages::staticMetaObject = { {
    &ExtensionSystem::IPlugin::staticMetaObject,
    qt_meta_stringdata_Packages.data,
    qt_meta_data_Packages,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Packages::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Packages.stringdata0))
...
QT_MOC_EXPORT_PLUGIN(Packages, Packages)
