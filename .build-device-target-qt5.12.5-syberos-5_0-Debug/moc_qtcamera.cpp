...
#include "../platforms/syberos/syberh-plugins/qrcode/src/qrcode/qtcamera.h"
...
void QtCamera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtCamera::mediaObjectChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QtCamera::*)(int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtCamera::savedImage)) {
                *result = 1;
                return;
            }
        }
